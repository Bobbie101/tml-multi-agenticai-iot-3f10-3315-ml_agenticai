         ...
         spec:
           ...
           - name: tml-multi-agenticai-iot-3f10-3315-ml_agenticai
             ...
             - name: step1solutiontitle # STEP 1 solutiontitle field can be adjusted here. 
               value: 'Marine Sensor AI Monitoring Solutio '                              
             - name: step1description # STEP 1 description field can be adjusted here. 
               value: 'An real-time marine sensor monitoring solution designed to detect temperature increases, shifts in underwater environmental conditions, and unusual biological activity for ocean observation and early anomaly detection.'                                          
             - name: KUBEBROKERHOST
