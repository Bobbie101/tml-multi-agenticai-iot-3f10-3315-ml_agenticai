...
.. code-block::
   ...
   http://localhost:6060/iot-failure-machinelearning.html?topic=all-agents-responses,iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=100&topictype=prediction&append=0&secure=1
...
.. code-block::
   ...
   http://tml.tss/viz/iot-failure-machinelearning.html?topic=all-agents-responses,iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=100&topictype=prediction&append=0&secure=1
