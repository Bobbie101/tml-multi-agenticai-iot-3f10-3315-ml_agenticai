[tml-multi-agenticai-iot-3f10-3315-ml_agenticai] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-3315-ml_agenticai] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-3315-ml_agenticai] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Bobbie101/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/Bobbie101/raspberrypi.git  \-\-env CHIP=arm64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=58843  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Bobbie101'  \-\-env DOCKERUSERNAME='Bobbie101'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-arm64
...
.. important::
   http://localhost:9005/iot-failure-machinelearning.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[tml-multi-agenticai-iot-3f10-3315-ml_agenticai] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Bobbie101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10-3315
...
.. important::
   solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-3315
...
.. important::
   VIPERHOST_PRODUCE=192.168.65.3, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=192.168.65.3, VIPERPORT_PREPROCESS=55291, VIPERHOST_PREPOCESS2=192.168.65.3, VIPERPORT_PREPROCESS2=60133, VIPERHOST_PREPOCESS_PGPT=192.168.65.3, VIPERPORT_PREPROCESS_PGPT=55299, VIPERHOST_ML=192.168.65.3, VIPERPORT_ML=56907, VIPERHOST_PREDCT=192.168.65.3, VIPERPORT_PREDICT=55311, HPDEHOST=192.168.65.3, HPDEPORT=59089, HPDEHOST_PREDICT=192.168.65.3, HPDEPORT_PREDICT=56773

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2781-tml-multi-agenticai-iot-3f10-3315-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-preprocess-1833-tml-multi-agenticai-iot-3f10-3315-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-ml-1764-tml-multi-agenticai-iot-3f10-3315-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-predict-795-tml-multi-agenticai-iot-3f10-3315-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-agenticai-3619-tml-multi-agenticai-iot-3f10-3315-ml_agenticai,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
